...
const dailyPhrases: Record<string, Phrase[]> = {
  ...
  "daily-im-planning-to": [["週末に部屋を片付ける予定です。", "clean up my room this weekend", ["chores"]], ["夏に沖縄へ旅行する予定です。", "travel to Okinawa this summer", ["travel"]], ["仕事の後に歯医者へ行く予定です。", "go to the dentist after work", ["appointment"]], ["来月から英会話を始める予定です。", "start English lessons next month", ["learning"]], ["今夜は早く寝る予定です。", "go to bed early tonight", ["health"]]],
  "daily-how-was": [["週末はどうでしたか。", "your weekend", ["weekend"]], ["昨日の会議はどうでしたか。", "the meeting yesterday", ["work"]], ["旅行はどうでしたか。", "your trip", ["travel"]], ["新しいレストランはどうでしたか。", "the new restaurant", ["food"]], ["映画はどうでしたか。", "the movie", ["movie"]]],
  "daily-do-you-want-to": [["昼ごはんを一緒に食べませんか。", "grab lunch together", ["food"]], ["週末に映画を見に行きませんか。", "watch a movie this weekend", ["movie"]], ["少し休憩しませんか。", "take a short break", ["break"]], ["仕事の後にコーヒーを飲みませんか。", "get a coffee after work", ["cafe"]], ["今度うちに遊びに来ませんか。", "come over to my place sometime", ["invitation"]]],
  "daily-i-feel-like": [["今日は何か温かいものが食べたい気分です。", "eating something warm today", ["food"]], ["今夜は家でのんびりしたい気分です。", "staying home and relaxing tonight", ["relax"]], ["少し散歩したい気分です。", "taking a short walk", ["health"]], ["今日は誰とも話したくない気分です。", "being alone today", ["mood"]], ["甘いものが食べたい気分です。", "having something sweet", ["food"]]],
  "daily-have-you-ever": [["海外で働いたことはありますか。", "worked abroad", ["work"]], ["この店で食べたことはありますか。", "eaten at this restaurant", ["food"]], ["富士山に登ったことはありますか。", "climbed Mt. Fuji", ["travel"]], ["道に迷ったことはありますか。", "gotten lost", ["experience"]], ["徹夜で仕事をしたことはありますか。", "pulled an all-nighter for work", ["work"]]]
};
